    ...
    >
      ...
      <div className="linhaModal-tecnico">
        <div className="div-placaModal-tecnico">
          ...
          />
          {this.state.fieldFalha.newPlaca ? (
            <p className="div-feedbackError">{this.state.message.newPlaca}</p>
          ) : null}
        </div>
      </div>
    </Modal>
      ...
      <div className="div-card-tecnico">
        ...
        <div className="linha1-tecnico">
          <div className="div-nome-tecnico">
            ...
            <div className="div-inputs">
              ...
              />
              {this.state.fieldFalha.nome ? (
                <p className="div-feedbackError">{this.state.message.nome}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className="div-cnh-tecnico">
            ...
            <div className="div-inputs">
              ...
              />
              {this.state.fieldFalha.cnh ? (
                <p className="div-feedbackError">{this.state.message.cnh}</p>
              ) : null}
            </div>
          </div>
        </div>
        ...
        <div className="linha1-tecnico">
          ...
          <div className="div-rodizio-tecnico">
            ...
            <Switch
              checked={this.state.externo}
              onChange={this.onChangeExterno}
            />
          </div>
        </div>
        ...
        <div className="linha-button-tecnico">
          <Button
            className="button"
            type="primary"
            onClick={this.saveTargetUpdateTechnician}
