      ...
      return this.state.OsArray.rows.map((line) => (
        <div className="div-100-Gentrada">
          ...
          >
            ...
            <div className="cel-rs-cabecalho-GCadastros">{line.name}</div>
            <div className="cel-cnpj-cabecalho-GCadastros">{line.category}</div>
  ...
  Tables = () => {
    if (this.state.gerenciar === 'produtos') {
      return (
        <div className="div-tables-GCadastros">
          <div className="div-cabecalho-GCadastros">
            <div className="cel-os-cabecalho-GCadastros">SKU</div>
            <div className="cel-rs-cabecalho-GCadastros">Produto</div>
            <div className="cel-cnpj-cabecalho-GCadastros">Categoria</div>
            <div className="cel-data-cabecalho-GCadastros">Marca</div>
            <div className="cel-acoes-cabecalho-GCadastros">Tipo</div>
            <div className="cel-edit-cabecalho-GCadastros" />
          </div>
      ...
      return (
        <div className="div-tables-GCadastros">
          <div className="div-cabecalho-GCadastros">
            <div className="cel-cnpj-cabecalho-GCadastros">Cnpj</div>
            <div className="cel-rs-cabecalho-GCadastros">Razão social</div>
            <div className="cel-uf-cabecalho-GCadastros">UF</div>
            <div className="cel-nome-cabecalho-GCadastros">Nome</div>
            <div className="cel-telefone-cabecalho-GCadastros">Telefone</div>
            <div className="cel-edit-cabecalho-GCadastros" />
          </div>
      ...
      return (
        <div className="div-tables-GCadastros">
          <div className="div-cabecalho-GCadastros">
            <div className="cel-tecnico-cabecalho-GCadastros">Técnico</div>
            <div className="cel-externo-cabecalho-GCadastros">Externo</div>
            <div className="cel-carro-cabecalho-GCadastros">Placa</div>
            <div className="cel-cnh-cabecalho-GCadastros">Validade CNH</div>
            <div className="cel-edit-cabecalho-GCadastros" />
          </div>
