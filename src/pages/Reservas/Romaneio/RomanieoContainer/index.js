    ...
    const query = {
      filters: {
        ...
        technicianReserve: {
          specific: {
            data:
              tecnico !== 'LABORATORIO' ? { start: data, end: data } : undefined,
          },
        },
        osParts: {
          specific: {
    ...
    if (e.which === 13 || e.keyCode === 13) {
      ...
      if (status === 200 && data) {
        ...
        if (linhaUnica) {
          ...
          index = R.findIndex(R.propEq('produto', data.productBase.product.name))(
            this.state.rows
          )
        }
                          ...
                          <Checkbox
                            ...
                            onChange={(e) => {
                              this.setState((prevState) => {
                                ...
                                rowsSelecteds.splice(
                                  10 * (this.state.current - 1) + idx,
                                  1,
                                  {
                                    ...rowsSelecteds[
                                      10 * (this.state.current - 1) + idx
