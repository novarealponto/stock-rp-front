...
import './index.css';
import { Select, Button, Input, Spin, DatePicker } from 'antd';
...
class GerenciarEstoqueSupPage extends Component {
  ...
  getSupProduct = async pdf => {
    ...
    if (status === 200) this.setState({ products: data.rows, count: data.count, index: -1 });
  };
  ...
  getEntrance = async pdf => {
    ...
    if (status === 200) this.setState({ entradas: data.rows, count: data.count, index: -1 });
  };
  ...
  getOut = async () => {
    ...
    if (status === 200) this.setState({ saidas: data.rows, count: data.count, index: -1 });
  };
        ...
        return (
          <div className="div-linha-avancado-Rtecnico">
            <div className="div-linha1-avancado-Rtecnico">
              ...
              <div className="cel-quant-cabecalho-gerEst-search"></div>
  ...
  render() {
    return (
      <div className="div-card-Gentrada">
                ...
                onClick={async () => {
                  switch (this.state.select) {
                    ...
                    case 'entrada':
                      ...
                      await CreatePDFSuprimento(this.state.select, this.state.entradas);
                      break;
                    default:
                      break;
                  }
            ...
            <div className="div-block-table-gerEst">
              {this.state.products.map((product, idx) => (
                <div
                  ...
                  style={{
                    color: product.minimumQuantity > product.amount ? 'red' : null
                  }}
                >
                  <div className="div-cabecalhoLinha-gerEst">
                    <div className="cel-produto-cabecalho-gerEst">{product.name}</div>
                      ...
                      <div className="div-linhaMaisInfoMap-gerEst">
                        {product.supEntrances.map(supEntrance => (
                          <div className="div-linhaMap-gerEst">
                            ...
                            <div className="div-quant-mais-gerEst">{supEntrance.amount}</div>
                  ...
                  <div className="div-separate-Gentrada" style={{ width: '100%' }} />
                </div>
              ))}
            </div>
        ...
        {this.state.select === 'entrada' && (
          <div className="div-main-emprestimo">
            <div className="div-cabecalho-estoque" style={{ backgroundColor: '#f0f0f0' }}>
              ...
              {this.state.entradas.map((entrada, idx) => (
                <div className="div-block-row-table-gerEst">
                  <div className="div-cabecalhoLinha-gerEst">
                    ...
                    <div className="cel-produto-cabecalho-gerEst">{entrada.supProduct.name}</div>
                    <div className="cel-quantEnt-cabecalho-gerEst">{entrada.amount}</div>
                    <div className="cel-data-cabecalho-gerEst">{entrada.responsibleUser}</div>
                  ...
                  {this.state.index === idx && (
                    <div className="div-mais-gerEst">
                      ...
                      <div className="div-linhaMaisInfo-gerEst">
                        ...
                        <div className="div-preco-mais-gerEst">{entrada.priceUnit}</div>
                        <div className="div-total-mais-gerEst">{entrada.total}</div>
                      </div>
                    </div>
                  )}
                  <div className="div-separate-Gentrada" style={{ width: '100%' }} />
        ...
        {this.state.select === 'saida' && (
          <div className="div-main-emprestimo">
            <div className="div-cabecalho-estoque" style={{ backgroundColor: '#f0f0f0' }}>
              ...
              <div className="cel-solicitante-cabecalho-gerEst">Solicitante</div>
              <div className="cel-solicitante-cabecalho-gerEst">Usuário liber.</div>
              ...
              {this.state.saidas.map((saida, idx) => (
                <div className="div-block-row-table-gerEst">
                  <div className="div-cabecalhoLinha-gerEst">
                    ...
                    <div className="cel-produtoSai-cabecalho-gerEst">{saida.supProduct.name}</div>
                    <div className="cel-solicitante-cabecalho-gerEst">{saida.solicitante}</div>
                    <div className="cel-solicitante-cabecalho-gerEst">{saida.responsibleUser}</div>
                  ...
                  {this.state.index === idx && (
                    <div className="div-mais-gerEst">
                      <div className="div-linhaMais-gerEst">
                        <div className="div-email-mais-gerEst">Email Solicitante</div>
                        <div className="div-email-mais-gerEst">Email responsável</div>
                        <div className="div-quant-mais-gerEst">Quant. saída</div>
                      </div>
                      <div className="div-linhaMaisInfo-gerEst">
                        <div className="div-email-mais-gerEst">{saida.emailSolic}</div>
                        <div className="div-email-mais-gerEst">{saida.emailResp}</div>
                        <div className="div-quant-mais-gerEst">{saida.amount}</div>
                      </div>
                    </div>
                  )}
                  <div className="div-separate-Gentrada" style={{ width: '100%' }} />
